...
const Navbar = () => {
    ...
    const {user, setUser, axios, setShowUserLogin, navigate, setSearchQuery, searchQuery, getCartCount, fetchUser} = useAppContext();
    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick= {() => navigate("/cart")} className="relative cursor-pointer">
                    ...
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-primary w-[18px] h-[18px] ro unded-full">{getCartCount()}</button>
                </div>
            ...
            <div className='items-center gap-6 sm:hidden flex'>
                <div 
