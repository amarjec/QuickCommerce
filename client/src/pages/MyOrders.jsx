        ...
        <div className='flex flex-col items-end w-max mb-8'>
         ...
         <div className="md:p-10 p-4 space-y-4">
            {myOrders.map((order, index) => (
                <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 -y-5 max-w-4xl' >
                    ...
                    >
                        <div key={itemIndex} className='flex items-center mb-4 md:mb-0'>
                        ...
                        <div className='flex flex-col justify-center md:m1-8 mb-4 md:mb-0'>
