...
export const productList = async (req, res) => {
     try {
        ...
        console.error(error.message); // Use console.error for logging errors
        return res.status(500).json({ success: false, message: "Something went wrong while fetching products." });
    }
...
export const productById = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: "Something went wrong while fetching the product." });
    }
...
export const changeStock = async (req, res) => {
    try {
        ...
        return res.status(200).json({ success: true, message: "Product stock updated successfully.", product });
    } catch (error) {
        console.log(error.message);
        return res.status(500).json({ success: false, message: "Something went wrong while updating product stock." });
    }
